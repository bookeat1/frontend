...
module.exports = () => {
  ...
  return {
    ...config,
    // Версия обязана быть ВЫШЕ той, что уже выпущена в App Store, иначе Apple
    // отбивает загрузку кодами 90062 и 90186: «поезд версии закрыт для новых
    // сборок». 1.5 выпущена 20.08.2026 и с тех пор закрыта — сборка 3 в неё уже
    // не прошла. Проверять занятые версии перед сборкой:
    //   uv run --with pyjwt python ~/.bookeat/asc.py \
