 ...
 * осознанно:
 *
 *   1. Плитка ленты ОТКРЫВАЕТ ЭКРАН РУБРИКИ (`/gastroguide/rubric/:slug`), а
 *      не страницу подборки и не отбор списка под собой. Маршрут строится по
 *      первому слагу из `categorySlugs`: плитка нарисована как рубрика, а
 *      собрана из подборки, и эти два слага РАЗНЫЕ.
...
describe("экран гастрогида", () => {
  it("нажатие на плитку открывает экран рубрики, а не страницу подборки", async () => {
