...
/**
 * Компания по умолчанию — двое. Не «просто число»: дата и гости уходят серверу
 * ТОЛЬКО парой, поэтому всякий раз, когда человек назвал одну половину, вторая
 * обязана чем-то заполниться. Один экспорт на все такие места (капсула
 * фильтров и шторка выбора на главной), иначе они разъедутся и один и тот же
 * тап дал бы разную выдачу.
 */
