 ...
 *   • Плашка «WELCOME DRINK» и кнопка «Забронировать» ПРОКРУЧИВАЮТ к списку
 *     точек: страницы акции у welcome drink не существует, а бронировать
 *     вместо гостя одну из трёх точек страница не вправе.
...
export function OceanBasketScreen() {
  ...
  // Куда прокручивать по «Забронировать» и по плашке welcome drink. Меряется
  // разметкой, а не считается по числам макета: высота шапки зависит от
  // безопасной зоны, а высота карты — от ширины экрана.
  ...
  return (
    <View style={styles.root}>
      ...
      >
        <OceanHero onBack={() => router.back()} onShare={() => void share()} onWelcomeDrink={scrollToPoints} />
