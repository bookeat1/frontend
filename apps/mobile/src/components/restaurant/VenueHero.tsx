...
export function VenueHero({
  ...
  // 2026-08-24, откат числового диапазона от 2026-08-20), тем же алфавитом,
  // что на карточках списков и в чипах фильтра цены. Ступень есть у каждого
  // заведения (price_category с сервера), поэтому в подписи она всегда.
  const subtitle = [cuisineLine(restaurant.cuisines), restaurant.priceLevel]
    .filter(Boolean)
    .join(" · ");
