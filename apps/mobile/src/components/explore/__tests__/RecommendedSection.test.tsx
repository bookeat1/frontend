import type { RestaurantsPicksResult, RestaurantSummary } from "@bookeat/api";
      ...
      items: [
        {
          ...
          match: {
            score: 400,
            reasons: [
              { code: "cuisine_match", points: 400, params: { cuisineCodes: ["seafood"] }, detail: "" },
            ],
          },
        },
      ],
