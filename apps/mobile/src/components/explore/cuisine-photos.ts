 ...
 *
 * Keys checked against the live catalog on 2026-08-10: the distinct
 * `cuisine_type` values then were Европейская, Средиземноморская, Казахская,
 * Морепродукты, Турецкая, Греческая, Французская, Восточная (plus Итальянская
 * on venues that are currently hidden).
 */
