...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Кто администратор платформы. Глобальная роль — не роль в заведении
      // (owner/manager/hostess остаются в «Настройках»), поэтому раздел
      // здесь, а не в венюшной группе.
      { href: "/roles", label: t.admin.nav.roles },
    ],
  },
];
