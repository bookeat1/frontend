  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        "guide-editorial-x": px(webGuidePage.hero.paddingX),
        "guide-editorial-t": px(webGuidePage.hero.paddingTop),
        "guide-editorial-b": px(webGuidePage.hero.paddingBottom),
      ...
      height: {
        ...
        "guide-editorial-hero": px(webGuidePage.hero.height),
