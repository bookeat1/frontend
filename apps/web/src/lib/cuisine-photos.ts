 ...
 * (латиница). Своего снимка нет у ТРЁХ кодов справочника — `georgian`,
 * `authors` и `indian` (последний добавлен редакцией 01.09.2026): их нет ни в
 * макете (кадр 3253:2 рисует десять кухонь, этих трёх среди них нет), ни в R2,
 * ни в мобильных ассетах. Им достаётся монограмма, и это вопрос к дизайнеру, а
 * не забытый случай. Ещё двум — `japanese` и `pan_asian` — снимки нашлись в
 * макете и добавлены 31.08.2026.
 */
