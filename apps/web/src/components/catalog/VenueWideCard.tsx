 ...
 * описание. В обычном случае ряд карточек всё равно ровный.
 *
 ...
 * рисовать данные.
 *
 * Решением владельца от 07.09.2026 (узел «Results» 3525:14461, сверено по
 * `results.png`) с карточки убран и суррогатный ряд признаков «открыто
 * сейчас» / «онлайн-бронь», который раньше стоял в геометрии слота вместо
 * настоящих кнопок времени: онлайн-бронь через сайт как самостоятельная
 * подсказка на карточке выдачи в макете отсутствует. `acceptsOnlineBookings`
 * по-прежнему приходит с бэка и используется на странице заведения — только
 * не здесь.
 *
