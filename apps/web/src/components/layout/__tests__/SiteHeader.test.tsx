...
describe("SiteHeader", () => {
  it("рисует все пункты меню из макета — их ШЕСТЬ", () => {
    ...
    // Порядок подтверждён владельцем 2026-09-09 (постмёрдж-фиксы к PR #177):
    // «Главная», «Заведения», «Акции», «Афиша», «Гастрогид», «Статьи». Роуты
    // существуют с 2026-09-05 («Афиша» — /events, узел 5033:6703; «Статьи» —
    // /articles, узел 5033:7382), с 2026-09-07 («Акции» — /promos, см.
    // `SHOW_PROMOS_LINK`) и с 2026-09-09 («Гастрогид» — /guide).
  ...
  /**
   * Дыра № 1 (`apps/web/docs/responsive.md`, § 5): ниже `xl` строки макета
