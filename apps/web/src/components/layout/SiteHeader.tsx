...
export const HEADER_NAV: readonly NavItem[] = [
  ...
  /**
   * Пункт «Акции» — за `SHOW_PROMOS_LINK` (`components/home/Cards.tsx`),
   * тем же приёмом, что был у «Афиши»/«Статьи» до своих роутов (см.
   * комментарий выше). Листинг `/promos` появился 2026-09-07 (владелец
   * отменил решение от 2026-09-04 «Акции на веб не переносим»), флаг включён.
   */
