 ...
 * макета (318, 190, 300 — первые два обновлены правкой владельца 2026-09-15,
 * см. `webHomePromoCard`/`webHomeEventCard`) живут ТОЛЬКО под `lg:`, ниже —
 * размер мобильной карточки. Замок против возврата голого `h-[300px]`: он не
 * ломает 360, и глазами его пропустить проще всего.
 */
