 ...
 *
 *   • плитка рубрики (5039:10258): 282×200, ЧЕТЫРЕ в ряд (`FourUp` в
 *     `GuideScreen.tsx`), поле 16, золотая надпись 14 + название 20;
 *   • «Выбор редакции» (5040:10277): 592×347, ДВЕ в ряд (`HalfUp`, но
 *     подборка сейчас ровно одна — второй слот пустует, грид не тянет
 *     карточку на всю ширину), поле 24, надпись 18 + заголовок 26 + подпись
 *     20;
