export const ru = {
  ...
  admin: {
    ...
    restaurant: {
      gateTitle: "Выберите ресторан",
      gateSubtitle:
        "Введите идентификатор ресторана (UUID), которым вы управляете. Мы проверим доступ.",
      idLabel: "Идентификатор ресторана",
      idPlaceholder: "00000000-0000-0000-0000-000000000000",
      confirm: "Открыть панель",
      checking: "Проверяем доступ…",
      forbidden: "У вас нет доступа к этому ресторану",
      notFound: "Ресторан с таким идентификатором не найден",
      invalidId: "Введите корректный UUID ресторана",
      switch: "Сменить ресторан",
      pickTitle: "Ваши рестораны",
      pickSubtitle: "Выберите ресторан, чтобы открыть панель управления",
      loadingList: "Загружаем ваши рестораны…",
      emptyTitle: "Не найдено ни одного ресторана",
      emptySubtitle:
        "За вами не закреплён ни один ресторан. Можно указать идентификатор вручную.",
      manualEntry: "Ввести идентификатор вручную",
      roleOwner: "Владелец",
