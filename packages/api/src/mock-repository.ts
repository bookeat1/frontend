 ...
 * `MockRestaurantRepository` (владеет `getRecommendedRestaurants`, персонализация v1
 ...
 * см. doc-комментарий у `MockRestaurantRepository.getRecommendedRestaurants`. */
...
export class MockRestaurantRepository implements RestaurantRepository {
   ...
   */
  /**
   * `data.mode` и, при активном моковом профиле, `match` на карточках —
   * спека `foodie-personalization-v1-20260916.md` §5.6.
   *
