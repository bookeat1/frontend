...
export const exploreLayout = {
   ...
   * не влезало ни в одну строку: RN обрезал его многоточием. 84 + сжатие
   * шрифта до 0.75 (12 → 9) дают самому длинному названию боевого каталога
   * поместиться ЦЕЛИКОМ. Цена — на экране 360 видно ~3.4 кружка вместо ~3.9;
   * обрезанное название стоит дороже.
   */
  cuisineChipLabel: 84,
