...
export const colors = {
  ...
  guide: {
     ...
     * 3192:6268). */
    gold: "#EDD19E",
    /** Заголовки секций — #141414 (node 3192:6260). Отдельный токен, а не
     * `text.primary` (#1B1B1B): оттенки соседние, но макет называет этот. */
    headline: "#141414",
     ...
     *   • «Выбор редакции» (3192:6266) — 0.85, старт 0 % (три строки текста);
     *   • гастропрогулка (3192:6275) — 0.82, старт 25 %.
     */
    rubricScrimEnd: "rgba(0, 0, 0, 0.8)",
    editorPickScrimEnd: "rgba(0, 0, 0, 0.85)",
