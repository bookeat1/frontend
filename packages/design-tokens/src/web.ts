...
export const webHero = {
  ...
  /** Три стопа заливки узла 3525:14143 (сверено REST 2026-09-15, старое
   * значение 0.62 на 45% было ошибочным): rgba(13,8,8) с прозрачностью
   * 0.55 → 0 на 45% → 0.88. Середина градиента ПРОЗРАЧНАЯ — снимок должен
   * быть виден почти без затемнения на уровне панели поиска, тёмный только
   * у самого верха (под заголовком) и у низа кадра. */
  scrim:
 ...
 *
 *   • шапка-«издание» (5033:7100): чёрный кадр 1440×324, паддинг 126
 *     сверху/слева/справа, 32 снизу (сверено REST 2026-09-15 — паддинг по
 *     бокам у этого блока СВОЙ, 126, а не общий контейнер-паддинг 120),
 *     текст прижат к низу, просвет строк 6; надпись-рубрика 16 semibold с
 *     разрядкой 8 % золотом #EDD19E, слоган Playfair Display Italic 48,
 *     подпись 20/20;
...
export const webGuidePage = {
  hero: {
    ...
    paddingTop: 126,
    paddingBottom: 32,
    /** Свой боковой паддинг блока (не общий контейнер-паддинг 120). */
    paddingX: 126,
    copyGap: 6,
    eyebrowSize: 16,
    headlineSize: 48,
